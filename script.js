...
function enviarWhatsApp() {
  ...
  // Captura a localização do ponto de partida
  const localizacaoUsuario = `Localização: ${startPoint[0]}, ${startPoint[1]}`;

  // Número do WhatsApp da Pet Ride Express (você pode alterar)
